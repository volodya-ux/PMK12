...
public:
    ...
    DoubleLinkedList& operator=(DoubleLinkedList&& other) noexcept // оператор присвоєння перенсу
    {
        if (this != &other)
        {
            Clear();
    ...
    public:
        ...
        Iterator operator++(int) { Iterator temp(*this); ptr = ptr->next; return temp; } //префіксний
        Iterator& operator--() { ptr = ptr->prev; return *this; } // потсфіксний
